...
import './UnConnectSchoolList.scss';
...
interface IUnConnectSchoolsListProps extends StateProps, DispatchProps {
    match?: any;
    history?: any;
    location?: any;
...
class UnUnConnectSchoolsList extends React.Component<IUnConnectSchoolsListProps, IUnConnectSchoolsListState> {
    constructor(props) {
        super(props);
        this.state = {
            data_table: [],
    ...
    static getDerivedStateFromProps(nextProps?: IUnConnectSchoolsListProps, prevState?: IUnConnectSchoolsListState) {
...
export default connect(mapStateToProps, mapDispatchToProps)(UnUnConnectSchoolsList);